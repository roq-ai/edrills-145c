...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['drill-coordinator', 'administrator', 'drill-participant', 'drill-evaluator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Drill', path: '/drills', entity: 'drill', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    {
      name: 'Drill Result',
      path: '/drill-results',
      entity: 'drill_result',
    ...
    {
      name: 'Observer Request',
      path: '/observer-requests',
      entity: 'observer_request',
      service: AccessServiceEnum.PROJECT,
      icon: FiEye,
    },
    { name: 'Scenario', path: '/scenarios', entity: 'scenario', service: AccessServiceEnum.PROJECT, icon: FiLayers },
