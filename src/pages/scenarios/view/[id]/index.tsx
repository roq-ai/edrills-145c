...
import { getScenarioById } from 'apiSdk/scenarios';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('scenario', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/scenarios/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('drill', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/drills/create?scenario_id=${data?.id}`}>
